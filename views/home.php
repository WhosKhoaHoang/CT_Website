...
<html lang="en">
    ...
    <body data-spy="scroll" data-target="#my_nav_bar"> <!--data-spy and data-target are for jumping to particular sections of the page through links-->
        ...
        <div class="row" id="section1" >
            <h2 style="color:#777777; margin-bottom: 50px; margin-top: 50px; text-align: center;">1. Select Your Device To Start Repair</h2>
        ...
        <div class="row" id="section2">
            <p style="text-align: center; font-size: 100px;">SECTION 2</p>
        </div>
        <!-- SECTION 2 END -->
